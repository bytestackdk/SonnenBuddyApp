...
export const getLatestDataSuccess = createAction(GET_LATEST_DATA_SUCCESS, props<{ data: ILatestData }>());
export const getLatestDataFailed = createAction(GET_LATEST_DATA_FAILED, props<{ error: HttpErrorResponse }>());
