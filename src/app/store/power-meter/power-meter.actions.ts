...
import { ILatestData, IPowerMeter } from '../../api/models/battery.model';
...
export const getPowerMeterSuccess = createAction(
  GET_POWER_METER_SUCCESS,
  props<{ powerMeter: IPowerMeter[] }>()
);
export const getPowerMeterFailed = createAction(
  GET_POWER_METER_FAILED,
